export const SidebarIcon = ({ className }) => (
  <svg className={className} height="24" viewBox="0 0 24 24" width="24" preserveAspectRatio="xMidYMid meet" focusable="false">
    <g>
...
export const YourVideosIcon = ({ className }) => (
  <svg className={className} enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false">
...
export const LogoLoginGoogle = ({ className }) => (
  <svg className={className} viewBox="0 0 75 24" width="75" height="24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <g id="qaEJec">
      <path
        fill="#ea4335"
